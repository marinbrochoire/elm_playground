...
var $author$project$Theme$fontSizes = {body: 16, excerpt: 10, hero: 80, subtitle: 24, title: 44};
...
var $author$project$Theme$spacing = {large: 48, medium: 24, small: 12};
...
var $author$project$Navbar$navigation = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			$mdgriffith$elm_ui$Element$padding($author$project$Theme$spacing.medium),
			$mdgriffith$elm_ui$Element$centerY,
			$mdgriffith$elm_ui$Element$Background$color($author$project$Theme$colors.blue),
			$mdgriffith$elm_ui$Element$Font$color($author$project$Theme$colors.white),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Font$size($author$project$Theme$fontSizes.subtitle)
				]),
			$mdgriffith$elm_ui$Element$text('Marin Brochoire')),
			A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_Nil,
					{
						label: $mdgriffith$elm_ui$Element$text('Chats'),
						url: '/cat'
					}),
					A2(
					$mdgriffith$elm_ui$Element$link,
...
var $author$project$Footer$footer = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
		...
		[
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text('Coucou')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
					...
					switch (model.$) {
						case 'Failure':
							return A2(
								...
								$mdgriffith$elm_ui$Element$text('Impossible de charger le chat.'));
						case 'Loading':
							return A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
								...
								A2(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[$mdgriffith$elm_ui$Element$centerX]),
											$mdgriffith$elm_ui$Element$text(cat.title))
										])));
					}
				}(),
					function () {
...
var $author$project$Main$view = function (model) {
	...
	return {
		body: _List_fromArray(
			[
				A2($mdgriffith$elm_ui$Element$layout, _List_Nil, $author$project$Navbar$navigation),
				function () {
				switch (page.$) {
					case 'Cat':
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","config.js"], null)
